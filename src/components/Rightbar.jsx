      ...
      <Box position="fixed" width={300}>
        ...
        <Stack direction="row">
          <AvatarGroup max={4}>
            ...
            <Avatar
              alt="sky"
              src="https://img.freepik.com/free-photo/white-cloud-blue-sky-sea_74190-4488.jpg?w=2000"
            />
            <Avatar
              alt="Human"
              src="https://prod-discovery.edx-cdn.org/media/course/image/e77ad9c2-8921-4857-9535-3ad16c759832-51cde667b658.small.jpg"
            />
            <Avatar
              alt="Trevor"
              src="https://static.wikia.nocookie.net/pelea-versus/images/f/fd/TrevorPhilips-GTA5.png/revision/latest?cb=20141012200648&path-prefix=es"
            />
          </AvatarGroup>
        </Stack>
        ...
        <ImageList cols={3} rowHeight={100} gap={5}>
          <ImageListItem>
            <img
              src="https://concepto.de/wp-content/uploads/2018/10/pradera1-e1539894968596.jpg"
              alt=""
            />
          </ImageListItem>
          <ImageListItem>
            <img
              src="https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/D84AC96610A5FA8563A5DA537142A5FC032DD6C42F230E71C3964575B404F0E6/scale?width=2880&aspectRatio=1.78&format=jpeg"
              alt=""
            />
          </ImageListItem>
          <ImageListItem>
            <img
              src="https://animastic24x7.com/wp-content/uploads/2021/09/3-compressed.jpg"
              alt=""
            />
          </ImageListItem>
        </ImageList>
